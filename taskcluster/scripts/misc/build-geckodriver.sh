...
*-apple-darwin)
  ...
  RUSTFLAGS="-Clinker=$MOZ_FETCHES_DIR/clang/bin/clang++ -C link-arg=-isysroot -C link-arg=$MOZ_FETCHES_DIR/MacOSX26.4.sdk -C link-arg=-fuse-ld=lld -C link-arg=--target=$TARGET"
